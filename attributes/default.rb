...
default['objsrv']['nc_pwd']      = 'Uask3df0r1t!'
...
default['objsrv']['OS']          = 'nmo'
default['objsrv']['PS']          = 'nmp'
default['objsrv']['GS']          = 'nmg'
default['objsrv']['DS']          = 'nmw'
default['objsrv']['PA']          = 'nmp'
default['objsrv']['pa_ip']       = '10.1.1.41'
default['objsrv']['os_pa_name']  = 'NMO_PA'
default['objsrv']['ps_pa_name']  = 'NMP_PA'
default['objsrv']['ncoms']       = 'NMO'
default['objsrv']['p-ncoms']     = 'P_NMO'
default['objsrv']['b-ncoms']     = 'B_NMO'
default['objsrv']['bi-name']     = 'BI_GATE'
default['objsrv']['remedy']      = 'P_REMEDY_GATE'
